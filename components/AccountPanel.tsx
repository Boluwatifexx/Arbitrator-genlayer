...
import { useDisputes } from "@/lib/hooks/useDisputeResolution";
...
export function AccountPanel() {
  ...
  // Count disputes where the connected wallet is claimant or respondent
  const { data: disputes = [] } = useDisputes();
  const myDisputeCount = disputes.filter(
    (d) =>
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        ...
        <DialogContent className="brand-card border-2">
          <DialogHeader>
            ...
            <DialogDescription>
              Connect your MetaMask wallet to file or respond to disputes
            </DialogDescription>
          </DialogHeader>
        ...
        <div className="brand-card px-4 py-2 flex items-center gap-3">
          ...
          <div className="flex items-center gap-1">
            ...
            <span className="text-xs text-muted-foreground">
              {myDisputeCount === 1 ? "dispute" : "disputes"}
            </span>
          </div>
        </div>
        ...
        <div className="space-y-4 mt-4">
          ...
          <div className="brand-card p-4 space-y-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="text-2xl font-bold text-accent">{myDisputeCount}</p>
              <span className="text-sm text-muted-foreground self-end pb-1">
                {myDisputeCount === 1 ? "active dispute" : "active disputes"}
              </span>
            </div>
          </div>
